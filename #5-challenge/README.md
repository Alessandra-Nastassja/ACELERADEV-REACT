...
- Modularize os componentes na pasta components. :heavy_check_mark:
- Atualize os arquivos de componentes carregando corretamente seus estilos e suas marcações JSX. :warning:
